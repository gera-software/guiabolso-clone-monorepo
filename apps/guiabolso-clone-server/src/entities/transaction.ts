...
export class Transaction {
    ...
    public static create(transaction: { category?: Category, amount: number, description?: string, descriptionOriginal?: string, date: Date, comment?: string, ignored?: boolean }): Either<InvalidTransactionError | InvalidAmountError, Transaction> {
