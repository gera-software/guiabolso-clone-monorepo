import { Category, ManualCreditCardAccount, CreditCardInvoice, CreditCardTransaction, Institution, TransactionType, User, NubankCreditCardInvoiceStrategy } from "@/entities"
...
describe("Credit Card Invoice entity", () => {
    ...
    describe('create', () => {
        ...
        test("should not create an invoice if dueDate is before close date", () => {
            const account: ManualCreditCardAccount = ManualCreditCardAccount.create({name: accountName, balance: accountBalance, imageUrl, user, institution, creditCardInfo}, new NubankCreditCardInvoiceStrategy() ).value as ManualCreditCardAccount
            const validInvoice = {
